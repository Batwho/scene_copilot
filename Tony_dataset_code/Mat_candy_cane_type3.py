...
def shader_candy_cane03(nw: NodeWrangler):
    ...
    r_e_d_s_t_r_i_p_e_s = nw.new_node(Nodes.ColorRamp, input_kwargs={'Fac': wave_texture.outputs["Color"]}, label='RED STRIPES')
    r_e_d_s_t_r_i_p_e_s.color_ramp.elements.new(0)
    r_e_d_s_t_r_i_p_e_s.color_ramp.elements.new(0)
    r_e_d_s_t_r_i_p_e_s.color_ramp.elements[0].position = 0.0227
    r_e_d_s_t_r_i_p_e_s.color_ramp.elements[0].color = [1.0000, 0.0000, 0.0000, 1.0000]
    r_e_d_s_t_r_i_p_e_s.color_ramp.elements[1].position = 0.0591
    r_e_d_s_t_r_i_p_e_s.color_ramp.elements[1].color = [1.0000, 1.0000, 1.0000, 1.0000]
    r_e_d_s_t_r_i_p_e_s.color_ramp.elements[2].position = 0.1182
    r_e_d_s_t_r_i_p_e_s.color_ramp.elements[2].color = [1.0000, 0.0000, 0.0000, 1.0000]
    r_e_d_s_t_r_i_p_e_s.color_ramp.elements[3].position = 0.2330
    r_e_d_s_t_r_i_p_e_s.color_ramp.elements[3].color = [1.0000, 1.0000, 1.0000, 1.0000]
    ...
    g_r_e_e_n_s_t_r_i_p_e_s.color_ramp.elements.new(0)
    g_r_e_e_n_s_t_r_i_p_e_s.color_ramp.elements.new(0)
    g_r_e_e_n_s_t_r_i_p_e_s.color_ramp.elements[0].position = 0.0136
    g_r_e_e_n_s_t_r_i_p_e_s.color_ramp.elements[0].color = [0.0310, 0.4480, 0.0000, 1.0000]
    g_r_e_e_n_s_t_r_i_p_e_s.color_ramp.elements[1].position = 0.0477
    g_r_e_e_n_s_t_r_i_p_e_s.color_ramp.elements[1].color = [1.0000, 1.0000, 1.0000, 1.0000]
    g_r_e_e_n_s_t_r_i_p_e_s.color_ramp.elements[2].position = 0.1364
    g_r_e_e_n_s_t_r_i_p_e_s.color_ramp.elements[2].color = [0.0000, 0.4480, 0.0049, 1.0000]
    g_r_e_e_n_s_t_r_i_p_e_s.color_ramp.elements[3].position = 0.2557
    g_r_e_e_n_s_t_r_i_p_e_s.color_ramp.elements[3].color = [1.0000, 1.0000, 1.0000, 1.0000]
...
def apply(obj, selection=None, **kwargs):
    surface.add_material(obj, shader_candy_cane03, selection=selection)
