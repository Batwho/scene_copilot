...
def shader_candy_cane02(nw: NodeWrangler):
    ...
    r_e_d_s_t_r_i_p_e_s.color_ramp.elements[0].position = 0.1727
    r_e_d_s_t_r_i_p_e_s.color_ramp.elements[0].color = [1.0000, 0.0055, 0.0000, 1.0000]
    r_e_d_s_t_r_i_p_e_s.color_ramp.elements[1].position = 0.3500
    ...
    g_r_e_e_n_s_t_r_i_p_e_s.color_ramp.elements.new(0)
    g_r_e_e_n_s_t_r_i_p_e_s.color_ramp.elements[0].position = 0.0000
    g_r_e_e_n_s_t_r_i_p_e_s.color_ramp.elements[0].color = [0.0310, 0.4480, 0.0000, 1.0000]
    g_r_e_e_n_s_t_r_i_p_e_s.color_ramp.elements[1].position = 0.0341
    g_r_e_e_n_s_t_r_i_p_e_s.color_ramp.elements[1].color = [1.0000, 1.0000, 1.0000, 1.0000]
    g_r_e_e_n_s_t_r_i_p_e_s.color_ramp.elements[2].position = 0.1227
    g_r_e_e_n_s_t_r_i_p_e_s.color_ramp.elements[2].color = [0.0000, 0.4480, 0.0052, 1.0000]
    g_r_e_e_n_s_t_r_i_p_e_s.color_ramp.elements[3].position = 0.2239
...
def apply(obj, selection=None, **kwargs):
    surface.add_material(obj, shader_candy_cane02, selection=selection)
