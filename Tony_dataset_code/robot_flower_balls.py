...
def shader_bulb_2_002(nw: NodeWrangler):
    ...
    hue_saturation_value = nw.new_node(Nodes.HueSaturationValue, input_kwargs={'Hue': 0.4300, 'Color': colorramp_1.outputs["Color"]})
...
def geometry_nodes(nw: NodeWrangler):
    ...
    quadrilateral = nw.new_node('GeometryNodeCurvePrimitiveQuadrilateral', input_kwargs={'Height': 0.0700})
    ...
    set_material = nw.new_node(Nodes.SetMaterial,
        input_kwargs={'Geometry': instance_on_points, 'Material': surface.shaderfunc_to_material(shader_bulb_2_002)})
...
def apply(obj, selection=None, **kwargs):
    ...
    surface.add_material(obj, shader_bulb_2_002, selection=selection)
